...
1. **GitHub Security Advisories** (preferred): Go to [Security → Advisories → New draft advisory](https://github.com/labostack/anybill/security/advisories/new) and submit your report.
...
- **Keep Docker images updated** — pull `ghcr.io/labostack/anybill:latest` regularly
