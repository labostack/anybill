/** Checkout page — two-column Stripe-style layout with plan summary and provider selection. */
import { createSignal, onMount, For, Show } from "solid-js";
import { useSearchParams } from "@solidjs/router";
import { ArrowLeft, Lock, ShieldCheck } from "lucide-solid";
...
export function Checkout() {
    ...
    onMount(async () => {
        ...
        try {
            const res = await fetch(`${API}/info?sub_id=${params.sub_id}`);
            if (!res.ok) throw new Error("Failed to load checkout info");
